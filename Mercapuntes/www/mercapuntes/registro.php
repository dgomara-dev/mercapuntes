...
<?php
    /*
        ...
        Si ya hay una sesión iniciada, no podemos permitir que se pueda crear un usuario nuevo.
...
<head>
    <title>Mercapuntes - Registro</title>
    <meta charset="UTF-8" />
        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center">Crear cuenta de usuario</h5>
                        <p class="card-text text-center" id="mensaje"><?=$mensaje?></p>
                        <form class="form-signin" method="post" action="./src/usuarioCrear.php">
                            <div class="form-label-group">
                                <label for="usuario"><i class="fas fa-at"></i>&nbsp;Email</label>
                                <input type="email" name="usuario" id="usuario" class="form-control" maxlength="50" size="20" required="required" autofocus="autofocus" value="<?=$email?>" placeholder="Email" />
                            </div>
                            <div class="form-label-group">
                                <label for="clave"><i class="fas fa-key"></i>&nbsp;Contraseña</label>
                                <input type="password" name="clave" id="clave" class="form-control" placeholder="Contraseña" minlength="8" maxlength="20" size="20" required="required" />
                            </div>
                            <div class="form-label-group">
                                <label for="clave2"><i class="fas fa-key"></i>&nbsp;Repita la contraseña</label>
                                <input type="password" id="clave2" class="form-control" name="clave2" minlength="8" maxlength="20" size="20" required="required" placeholder="Repita la contraseña" />
                            </div>
                            <button class="btn btn-lg btn-warning btn-block text-uppercase" type="submit">Registrarse</button>
                            <hr class="my-4">
                            <p class="card-text text-center">¿Ya estás resgistrado? <a href="./iniciarSesion.php">¡Inicia sesión!</a></p>
                        </form>
                    </div>
                </div>
            </div>
